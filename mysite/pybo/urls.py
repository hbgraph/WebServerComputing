...
urlpatterns = [
    ...
    path('vote/comment/question/<int:comment_id>/', vote_views.question_vote_comment, name='question_vote_comment'),
    path('vote/comment/answer/<int:comment_id>/', vote_views.answer_vote_comment, name='answer_vote_comment'),
]